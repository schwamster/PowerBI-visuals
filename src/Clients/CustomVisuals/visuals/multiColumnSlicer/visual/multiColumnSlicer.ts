        ...
        export class MultiColumnSlicerConverter {
            ...
            public constructor(dataView: DataView, interactivityService: IInteractivityService) {
                ...
                if (dataViewCategorical.categories && dataViewCategorical.categories.length > 0) {
                    ...
                    this.categoryFormatString = valueFormatter.getFormatString(this.category.source, multiColumnSlicerProps.formatString);
                }
            ...
            public convert(): void {
                ...
                if (this.categoryValues) {
                    ...
                    for (var idx = 0; idx < this.categoryValues.length; idx++) {
                        var selected = isCategoryColumnSelected(multiColumnSlicerProps.selectedPropertyIdentifier, this.category, idx);
                        if (selected != null) {
                    ...
                    for (var categoryIndex: number = 0, categoryCount = this.categoryValues.length; categoryIndex < categoryCount; categoryIndex++) {
                        ...
                        var categoryIsSelected = isCategoryColumnSelected(multiColumnSlicerProps.selectedPropertyIdentifier, this.category, categoryIndex);
